...
public abstract class Round {
    private Integer id;
    private List<model.Match> matches;
    private Integer givenPoints;

    public Round(){
    }

    public Round(Integer id, List<model.Match> matches, Integer givenPoints, Double givenMoney) {
        this.id = id;
    ...
    public List<model.Match> getMatches() {
        return matches;
    }
